...
# [All validation functions like Run-OfficeValidation, Run-DriverValidation, etc. remain intact here]

# Example placeholder for the last main function for brevity:
function Run-ZipAndEmailResults {
    $timestamp = Get-Date -Format "yyyyMMdd_HHmmss"
    $hostname = $env:COMPUTERNAME
    $zipFilePath = "$ExportDir\ScriptExport_${hostname}_$timestamp.zip"

    # Detect modern Outlook
